...
```{r, fig.cap = "Microsoft Brand Love Framework from the powerpoint 'All Human Emotionality References Deck All Audiences' ... catchy", echo = FALSE, out.width = '100%'}
knitr::include_graphics("./img/brand_love_emotions.png")
```
